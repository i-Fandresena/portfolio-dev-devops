export const HERO_CONTENT = "Développeur Web & Mobile | DevOps Junior — j'automatise les déploiements et conçois des systèmes fiables en production.";

export const ABOUT_TEXT = "Développeur Web & Mobile et ingénieur DevOps junior. Je conçois des applications performantes et mets en place les pipelines et l'infrastructure nécessaires pour les rendre fiables en production. J'interviens sur l'automatisation (CI/CD), l'orchestration de conteneurs et l'infrastructure as code pour garantir des déploiements reproductibles et sécurisés.";
...
export const PROJECTS = [
  {
    ...
    category: 'devops',
    githubLink: 'https://github.com/i-Fandresena/amazon-clone-k8s-eks-argoCD',
    websiteLink: '',
  },
  {
    ...
    category: 'devops',
    githubLink: 'https://github.com/i-Fandresena/nextjs-docker-kubernetes-app',
    websiteLink: '',
  },
  {
    ...
    category: 'fullstack',
    githubLink: 'https://github.com/i-Fandresena/Mern_ChatApp',
  ...
  },
  {
    ...
    category: 'devops',
    githubLink: 'https://github.com/i-Fandresena',
    websiteLink: '',
  },
  {
    ...
    category: 'fullstack',
    githubLink: 'https://github.com/i-Fandresena/NetflixReact_Clone',
  ...
  },
  {
    ...
    category: 'fullstack',
    githubLink: 'https://github.com/i-Fandresena/Neeraj_Portfolio',
  ...
  },
  {
    ...
    category: 'fullstack',
    githubLink: 'https://github.com/i-Fandresena/PortFolio_React/tree/master',
...
export const CONTACT = {
  ...
  phoneNo: '+261386423449',
  email: 'ainafandresena9@gmail.com',
  social: {
    github: 'https://github.com/i-Fandresena',
    linkedin: '',
    twitter: '',
  }
};
